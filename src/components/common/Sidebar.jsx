...
import { Box, ChevronDown, ChevronLeft, ChevronRight, ChevronUpIcon, Copy, Ellipsis, Focus, Inbox, Layers2, Search, SquarePen, SquareUserRound, UsersRound } from "lucide-react";
            ...
            {!isLeftSidebarOpen ? (
                ...
                >
                    <div className="relative h-full pl-1 pr-4 flex flex-col">
                        ...
                        <div className="flex flex-col gap-0 mb-4">
                            <Accordion open={openAccordions.includes(2)} icon={
                                <ChevronDown size={16} className={`text-color-secondary ${openAccordions.includes(2) ? 'rotate-180' : ''}`} id={2} open={openAccordions.includes(2)} />}>
                                <AccordionHeader onClick={() => handleOpen(2)} className="text-xs border-none text-color-secondary mb-1 hover:bg-gray-700 rounded-md p-1">Projects</AccordionHeader>
                                <AccordionBody>
                                   <div className="flex items-center gap-1">
                                        <Button variant="text" ripple={true} className="flex items-center gap-2 w-full p-2 hover:bg-gray-700">
                                            <Box size={16} className="text-color-secondary" />
